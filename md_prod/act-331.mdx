...
1. (1) This Act may be called the [Diplomatic Immunities (Conferences with Commonwealth Countries) Act, 1963](/laws/act-331 "Diplomatic Immunities (Conferences with Commonwealth Countries) Act, 1963").(2) It extends to the whole of Bangladesh.(3) It shall come into force at once.
...
<Note>
  Click [here](http://bdlaws.minlaw.gov.bd/act-details-331.html) to see the original act on the Bangladesh Legal Database.
</Note>
