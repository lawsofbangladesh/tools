...
1. This Act may be called the <sup>[[2]](#footnote-2)</sup> [\* \* \*] [Vaccination Act, 1880](/laws/act-42 "Vaccination Act, 1880") ;
...
<Note>
  Click [here](http://bdlaws.minlaw.gov.bd/act-details-42.html) to see the original act on the Bangladesh Legal Database.
</Note>