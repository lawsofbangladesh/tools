...
### Penalty for contravention of rules
 ...
 <sup>[[4]](#footnote-4)</sup> [18A. Rules made under section 18 may provide that a breach of any of them shall be punishable with fine not exceeding one thousand <sup>[[5]](#footnote-5)</sup> [Taka].]
...
<Note>
  Click [here](http://bdlaws.minlaw.gov.bd/act-details-208.html) to see the original act on the Bangladesh Legal Database.
</Note>