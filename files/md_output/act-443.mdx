...
1. (1) This Order may be called the Asian Development Bank Order, 1973.    (2) It extends to the whole of Bangladesh.    (3) It shall come into force at once.
...
<Note>
  Click [here](http://bdlaws.minlaw.gov.bd/act-details-443.html) to see the original act on the Bangladesh Legal Database.
</Note>